...
$comments = getCommentsByOrder($connect, $_GET["numero"]);
?>
	...
	<body>
		...
		<main>
			...
			<section id="comments">
				...
				-->
				<!--commentaires-->
				<form id="com-inner"  method="post" action="./php/comments.php?numero=<?php echo $_GET['numero']?>">
					<?php
