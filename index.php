		...
		<main id="index-main">
			...
			<div id="page">
				...
				<section id="carousel" class="carousel slide carousel-fade" data-ride="carousel">
					...
					<div id="slide-txt">
						<h2>Tout les films répertoriés sur DownTwon Film</h2>
				...
				<!--films-->
				<section id="films">
					<h2 class="titre-main-page">Les derniers films sur DownTown Film</h2>
					<div>
						<?php
				...
				<h2 class="titre-main-page">Catégories</h2>
